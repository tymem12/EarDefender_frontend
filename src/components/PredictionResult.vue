<template>
  <div
    class="bg-white shadow-lg p-6 rounded-lg mb-10"
    style="width: 90%; margin-left: auto; margin-right: auto; margin-bottom: 20px;"
  >
    <!-- Header -->
    ...
    <div
      v-if="showTable"
      class="mt-6 overflow-x-auto bg-gray-50 p-4 rounded shadow-inner"
    >
